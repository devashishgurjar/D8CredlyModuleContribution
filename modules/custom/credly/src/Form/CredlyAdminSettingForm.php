...
class CredlyAdminSettingForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $StatusCode = credlyApiCall($AppApiSecret, $AppApiKey , $AdminUsername, $AdminPassword, $url);
      if ($StatusCode == 'TRUE') {
      ...
      $this->messenger()->addError($this->t('Credly Authentication failed, returning the following: %token', ['%token' => $StatusCode]));
    }
  }
}